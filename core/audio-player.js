...
musicName = audioplayer.querySelector(".track-details .name"),
musicArtist = audioplayer.querySelector(".track-details .artist"),
...
musicList = audioplayer.querySelector(".track-list"),
